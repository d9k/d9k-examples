...
(function () {
  ...
  //return true;
  //}
  var localStoreGet, localStoreSet, storeGet, storeSet;

  localStoreGet = function localStoreGet(store, path) {
  ...
  localStoreSet = function localStoreSet(store, path, value) {
    var curentPointer, i, pathPart, pathParts;
    pathParts = path.split('.');
    //var curentPointer = window._store;
    curentPointer = store;
  ...
  storeGet = function storeGet(path) {
    //  var pathParts = path.split('.');
    //  var curentPointer = window._store;
  ...
  storeSet = function storeSet(path, value) {
    //  var pathParts = path.split('.');
    //  var curentPointer = window._store;
