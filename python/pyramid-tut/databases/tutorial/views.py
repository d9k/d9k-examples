...
class WikiViews(object):
    ...
    @view_config(route_name='wikipage_add', renderer='wikipage_addedit.jinja2')
    def wikipage_add(self):
        ...
        if 'submit' in self.request.params:
            ...
            # or use just `transaction.commit()` instead `with transaction.manager`
    ...
    @view_config(route_name='wikipage_edit', renderer='wikipage_addedit.jinja2')
